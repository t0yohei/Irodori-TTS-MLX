...
For the v0.2 delivery plan that maps the GitHub issue cluster, dependency order, validation gates, and downstream consumer handoff boundary, see [docs/v0_2_delivery_plan.md](docs/v0_2_delivery_plan.md).
