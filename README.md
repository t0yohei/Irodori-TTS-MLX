...
For the mlx-audio interoperability evaluation, including the public `mlx-community/Irodori-TTS-*` artifact layout comparison, direct-loader boundary, DACVAE reference notes, and recommended adapter follow-ups, see [docs/mlx_audio_interop.md](docs/mlx_audio_interop.md).
