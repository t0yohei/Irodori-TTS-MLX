...
- **Do not publish RF-DiT weights as part of this issue:** this issue records RF-DiT eligibility only. The Semantic-DACVAE codec derivative has a separate #188 approval and hosted artifact PR.
