...
- v0.2 の delivery plan、GitHub issue 群の対応、依存順、検証 gate、downstream consumer handoff boundary は [docs/v0_2_delivery_plan.md](docs/v0_2_delivery_plan.md) を参照してください
...
- mlx-audio DACVAE artifact 比較: [docs/mlx_audio_dacvae_contract.md](docs/mlx_audio_dacvae_contract.md)
